---
name: "Colosseum"
description: "Adversarial multi-agent debate grounded in live web searches. Agents fact-check each other's claims, concede when proven wrong, and reach consensus or force a verdict after 5 rounds. Triggers: 'colosseum', '여러 AI에게 물어봐', 'AI 토론', '비판적으로 분석', '다양한 관점'"
author: "최진호"
created: "2026-03-17"
updated: "2026-04-04"
category: "Research"
...
## Phase 2: 1차 포지션 선언 (비공개 블라인드 초안)

모든 에이전트는 타 에이전트의 입장을 모른 상태에서 독립적으로 초안을 작성한다.
순차 공개 금지 — 전원 작성 완료 후 동시 공개.
...
Step 1: 각 에이전트(CLI 또는 Claude 역할) 독립 초안 작성 — 타 에이전트 입장 비공개 상태 유지.
Step 2: 전원 작성 완료 확인 후 동시 공개.
...
1. **독립성 붕괴**: 에이전트 간 evidence 출처 중복율 > 60% (INDEPENDENCE < 40)
2. **교착**: CONVERGENCE 2라운드 연속 변화 없음
3. **팩트체크 실패**: 어느 에이전트도 웹서치 결과로 상대를 반박하지 못한 라운드
...
- Devil's Advocate 반론을 근거 없이 기각하거나 무시 금지
- FinalScore 계산 생략 금지
